/* =========================================================
   ...
   - CORREÇÃO: permite novas lutas após uma luta concluída
   - CORREÇÃO: libera nextFight concluída antes de procurar nova luta
   - CORREÇÃO: tenta novamente gerar luta quando não existe próxima luta
========================================================= */
...
function clearCompletedFight() {
    ...
    /*
       A luta já terminou.
       Ela não pode continuar ocupando
       o slot de próxima luta.
    */
    ...
    console.log(
        "MMA LIFE: luta concluída liberada. Procurando próxima luta..."
    );
...
function ensureNextFight() {
    ...
    /*
       Se ainda existe uma luta válida,
       não criamos outra.
    */
    ...
    */
    ...
    /*
       PRIMEIRA TENTATIVA
       Sistema principal do empresário.
    */
    ...
    if (
        ...
        try {
            ...
            console.error(
                "Erro na primeira tentativa de procurar luta:",
                error
            );
        }
    }
    ...
    */
    ...
    if (
        ...
        try {
            ...
            console.error(
                "Erro na segunda tentativa de procurar luta:",
                error
            );
        }
    }
    ...
    */
    ...
    /*
       Se não foi encontrada imediatamente,
       não cria luta falsa.
       O empresário continuará procurando
...
function nextWeek() {
    ...
    /* =====================================================
       NOVO SISTEMA DE LUTAS
       
       IMPORTANTE:
       Se a luta anterior terminou, ela é removida
       de nextFight antes de procurar a próxima.
    ===================================================== */
    ...
    /* =====================================================
       ...
       Se não apareceu luta,
       tenta o sistema antigo/direto.
    ===================================================== */
    ...
    /* =====================================================
       ...
       Caso a luta antiga tenha ficado marcada
       como completed depois de alguma função,
    ...
    if (
        ...
        if (
            ...
            try {
                ...
                console.error(
                    "Erro na tentativa extra de procurar luta:",
                    error
                );
            }
        }
