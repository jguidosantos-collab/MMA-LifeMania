...
/* =========================================================
   FORÇAR VISIBILIDADE DA INTERFACE
   CORREÇÃO PRINCIPAL
========================================================= */
...
function showGame() {
    ...
    */
    ...
    /*
       LIMPAR O CONTEÚDO DA CRIAÇÃO
       PARA IMPEDIR QUE ELE FIQUE
       APARECENDO ACIMA DO JOGO
    */
    ...
    */
    ...
    /*
       GARANTIR QUE A PÁGINA
       VOLTE PARA O TOPO DO JOGO
    */
    ...
    try {
        ...
        console.warn(
            "Não foi possível voltar ao topo.",
            error
        );
...
function fightFallback() {
    ...
    content.innerHTML = `
        ...
        <div class="card">
            ...
            <p>
                Sistema de lutas está sendo carregado.
            </p>
