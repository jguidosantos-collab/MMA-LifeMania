...
function training() {
    ...
    content.innerHTML = `
        ...
        <div class="card">
            ...
            ${
                ...
                currentWeek.map(
                    treino => `
                        <div class="statline">
                            <span>${treino.icon} ${treino.name}</span>
                            <b>+${treino.gain.toFixed(2)}</b>
                        </div>
                    `
                ).join("")
                :
        ...
        <div class="card">
            ...
            <div class="statline">
                <span>Saúde</span>
                <b>${Math.round(player.health || 0)}%</b>
            </div>

            <div class="statline">
                <span>Fadiga</span>
                <b>${Math.round(player.fatigue || 0)}%</b>
            </div>
...
function nextWeek() {
    ...
    /*
     * Executa o treinamento programado.
     */
